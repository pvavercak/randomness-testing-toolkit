...
#include "version.h"
#include "strings.h"
#include "rttexception.h"
#include "clinterface/clargument.h"
#include "clinterface/batteryarg.h"
#include "clinterface/resultstoragearg.h"
...
private:
    ...
    T getArgumentValue(const std::string & argName) const {
        ...
        for(const auto & arg : arguments) {
            if(std::visit(cmpArgumentName, arg)) {
                try {
                    return std::get<ClArgument<T>>(arg).getArgumentValue();
